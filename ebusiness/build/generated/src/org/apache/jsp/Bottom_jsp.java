...
public final class Bottom_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            var products = JSON.parse(sessionStorage.getItem(\"cart\"));\n");
      out.write("            document.getElementById(\"cartamount\").innerHTML=products.length;\n");
      out.write("        </script>\n");
      out.write("    </head>\n");
      out.write("    <body>\n");
      ...
      out.write("                            <a href=\"Cart.jsp\"><button class=\"btn\"><span class=\"glyphicon glyphicon-shopping-cart\"></span> <span class=\"badge badge-info\" id=\"shoppingcart\">8</span></button></a>\n");
      out.write("                            ");
      ...
      out.write("                                <li><a tabindex=\"-1\" href=\"Bottom.jsp\"><span  class=\"select\">BOTTOM</span></a></li>\n");
      out.write("                                <li><a tabindex=\"-1\" href=\"Outware.jsp\">OUTWARE</a></li>\n");
      out.write("                                <li><a tabindex=\"-1\" href=\"Shoes.jsp\">SHOES</a></li>\n");
      out.write("                                <li><a tabindex=\"-1\" href=\"Accessories.jsp\">ACCESSORIES</a></li>\n");
      out.write("                            </ul>\n");
      ...
      out.write("                                        ");
                                            ...
                                            try (Connection conn = DriverManager.getConnection("jdbc:derby://localhost:1527/ebusiness", "ebusiness", "ebusiness")) {
                                                ...
                                                ResultSet rs = st.executeQuery("SELECT * from PRODUCT WHERE PRODUCT_TYPE='bottom'");
                                                while (rs.next()) {
