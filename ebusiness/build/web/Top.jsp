<%-- 
    Document   : Top
    Created on : Apr 16, 2015, 9:19:25 PM
    Author     : SONGSONG
--%>
                    ...
                    <div class="container-fluid">
                        <div class="col-md-2">
                            <ul class="nav sidebar-nav">
                                <li><a tabindex="-1" href="Top.jsp"><span  class="select">TOP</span></a></li>
                                    ...
                                    <div class="row">
                                        <%
                                            ...
                                            try (Connection conn = DriverManager.getConnection("jdbc:derby://localhost:1527/ebusiness", "ebusiness", "ebusiness")) {
                                                ...
                                                ResultSet rs = st.executeQuery("SELECT * from PRODUCT WHERE PRODUCT_TYPE='top'");
                                                while (rs.next()) {
