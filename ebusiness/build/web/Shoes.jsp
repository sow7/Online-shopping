<%-- 
    Document   : Shoes
    Created on : Apr 16, 2015, 9:21:33 PM
    Author     : SONGSONG
--%>
                    ...
                    <div class="container-fluid">
                        <div class="col-md-2">
                            <ul class="nav sidebar-nav">
                                ...
                                <li><a tabindex="-1" href="Shoes.jsp"><span  class="select">SHOES</span></a></li>
                                    ...
                                    <div class="row">
                                        <%
                                            ...
                                            try (Connection conn = DriverManager.getConnection("jdbc:derby://localhost:1527/ebusiness", "ebusiness", "ebusiness")) {
                                                ...
                                                ResultSet rs = st.executeQuery("SELECT * from PRODUCT WHERE PRODUCT_TYPE='shoes'");
                                                while (rs.next()) {
